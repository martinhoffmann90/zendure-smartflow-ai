...
class ZendureSmartFlowCoordinator(DataUpdateCoordinator[dict[str, Any]]):
    ...
    def __init__(self, hass: HomeAssistant, entry: ConfigEntry) -> None:
        ...
        self.entities = EntityIds(
            ...
            expensive_threshold=data["expensive_threshold_entity"],
            max_charge=data["max_charge_entity"],
            max_discharge=data["max_discharge_entity"],

            ac_mode=data["ac_mode_entity"],
            input_limit=data["input_limit_entity"],
